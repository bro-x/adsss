/*
Assignment no. 5	Roll n. :75

Title:	There are filght paths between cities. If there is a flight between city A and B then 
		there is an edge between the cities. The cost of the edge can be the time that flight 
		takes to reach city B from city A or the amount of fuel used for the journey. Represent 
		this as agraph. the node can be represented by airport name or name of the city. 
		Use adjacencylist representation of the graph or use adjacency matrix representation 
