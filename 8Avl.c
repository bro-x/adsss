...
sitrc@sitrc-OptiPlex-380:~/Desktop$ cd AVL
sitrc@sitrc-OptiPlex-380:~/Desktop/AVL$ g++ AVL.c
sitrc@sitrc-OptiPlex-380:~/Desktop/AVL$ ./a.out
...
Sudhir		sid
kalpesh		km
Enter the keyword to be searched from the dictionary: Ankita

 Meaning:Anki
sitrc@sitrc-OptiPlex-380:~/Desktop/AVL$ 
